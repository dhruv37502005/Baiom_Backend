# Generated by Django 4.2 on 2024-03-06 16:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='CourseTestimonial_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notes', models.FileField(blank=True, null=True, upload_to='course_notes/')),
                ('recorded_video_link', models.FileField(blank=True, null=True, upload_to='course_recorded_lectures/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
